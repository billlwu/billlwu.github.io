...
Did an exercise using historic volatility to normalize log return (which comes with negative skew!). Code and figures [here](SP_returns.html). [Reference](https://mathbabe.org/2011/07/24/measuring-historical-volatility/). An EWMA (with variable decay rate) was used to compute volatility. 
